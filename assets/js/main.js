...
;(function () {
  ...
  var I18N = {
    zh: {
      ...
      'f6.h': '全局快捷键', 'f6.p': '在系统任何地方按 Ctrl+Shift+A 唤起迷你输入条，想到什么一秒记下。',
      ...
      'f10.h': '多视图切换', 'f10.p': '今日清单在列表、四象限、卡片堆之间一键切换，同一份任务换个角度看。',
      'f11.h': '专注白噪音', 'f11.p': '雨声、雨打玻璃、流水、列车、洞穴六种真实录音，给专注铺一层背景音。',
      'cmp.eyebrow': '不一样的选择',
    ...
    en: {
      ...
      'f6.h': 'Global shortcuts', 'f6.p': 'Press Ctrl+Shift+A anywhere in the system to summon a mini input bar; capture a thought in a second.',
      ...
      'f10.h': 'Switchable views', 'f10.p': 'Flip the today page between list, Eisenhower matrix and card deck — one list, many angles.',
      'f11.h': 'Focus white noise', 'f11.p': 'Six real recordings — rain, rain on glass, waterflow, train, cave — as a background layer for focus.',
