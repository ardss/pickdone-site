...
;(function () {
  ...
  var I18N = {
    zh: {
      ...
      'q1.q': '真的完全离线吗？会不会偷偷联网？',
      'q1.a': '是。拾事没有任何账号体系与云端服务器，任务、专注记录、统计全部存储在本机数据库文件中；应用不采集任何数据。唯一可能的外部请求是检查更新，也可以在设置里改为手动检查。',
      'q2.q': '换电脑或重装系统，数据怎么办？',
      'q2.a': '你的全部数据就是一个数据库文件，加上自动备份目录。新机器装好应用后把文件拷回去即可；应用还内置一键从备份恢复，误删了也能找回。',
      'q3.q': '免费的，那靠什么维持？',
      'q3.a': '拾事是个人兴趣驱动的开源项目，MIT 协议，代码全部公开，不设付费墙、不塞广告。如果它对你有用，去 GitHub 点个 Star 就是最大的支持。',
      'q4.q': '支持 macOS / Linux 吗？',
      'q4.a': '目前主要在 Windows 10 / 11 上打磨与验证。macOS / Linux 在计划中，欢迎到 GitHub 提 issue 反馈需求，甚至参与适配。',
      ...
      'fin.p': '免费、开源、离线可用——5 分钟跑起来，不喜欢随时删。',
      'fin.cta': '免费下载', 'fin.cta2': 'GitHub 仓库',
      'foot.tag': '本地离线优先的待办 · 日程 · 番茄专注桌面应用。你的数据只属于你。',
    ...
    en: {
      ...
      'q1.q': 'Is it really offline? Does it phone home?',
      'q1.a': 'Yes, it is. PickDone has no account system and no cloud servers — tasks, focus records and stats all live in a local database file, and the app collects nothing. Checking for updates is the only outbound request, and it can be switched to manual in settings.',
      ...
      'q3.a': 'PickDone is a personal, passion-driven open-source project under MIT. No paywalls, no ads, all code public. If it helps you, a GitHub Star is the best support.',
      'q4.q': 'Is macOS / Linux supported?',
      'q4.a': 'Currently PickDone is polished and tested on Windows 10 / 11. macOS / Linux are on the roadmap — file an issue on GitHub to help prioritize, or join the porting effort.',
      ...
      'fin.p': 'Free, open source, fully offline — running in 5 minutes, delete anytime.',
      'fin.cta': 'Download free', 'fin.cta2': 'GitHub repository',
      'foot.tag': 'A local-first to-do · schedule · pomodoro desktop app. Your data belongs to you.',
      ...
      'q7.q': '“I’ll install it and never open it again.” How do you prevent that?',
      ...
      _title: 'PickDone — a local-first, offline Pomodoro to-do app',
      _htmlLang: 'en',
