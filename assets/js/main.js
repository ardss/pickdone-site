...
;(function () {
  ...
  var I18N = {
    zh: {
      ...
      'f6.h': '全局快捷键', 'f6.p': '在系统任何地方按 Alt+Shift+T 唤起迷你输入条，想到什么一秒记下。',
    ...
    en: {
      ...
      'f6.h': 'Global shortcuts', 'f6.p': 'Press Alt+Shift+T anywhere in the system to summon a mini input bar; capture a thought in a second.',
